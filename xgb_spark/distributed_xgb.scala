...
val training_data_df = spark.read.schema(schema).csv("/home/ubuntu/mc2/data/msd_training_data.csv")
...
// Evaluation
val test_data_df = spark.read.schema(schema).csv("/home/ubuntu/mc2/data/msd_test_data.csv")
